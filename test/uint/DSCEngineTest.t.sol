...
contract DSCEngineTest is Test {
    ...
    function testGetTokenAmountFromUsd() public {
        ...
        //$ETH = $2000 $100/$2000 = 0.05 ETH
        uint256 expectWeth = 0.05 ether;
        uint256 actualWeth = dsce.getAmountFromUsd(weth, usdAmount);
        assertEq(expectWeth, actualWeth);
        console.log("Actual WETH Amount:", actualWeth);
        console.log("WETH Price:", dsce.getUsdValue(weth, 1 ether));
    }

    function testDefaultWethPrice() public {
        assertEq(dsce.getUsdValue(weth, 1 ether), 2000 ether);
    }
    /*//////////////////////////////////////////////////////////////
                            COLLATERAL TEST
    //////////////////////////////////////////////////////////////*/
    ...
    function testCanDepositCollateralAndAccountInfo() public depoistedCollateral {
